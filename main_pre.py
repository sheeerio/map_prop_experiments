...
def main():
    ...
    try:
        ...
        print("Error: 'hidden' must be a valid JSON list (e.g., '[64, 32]').")
        sys.exit(1)
    ...
    try:
        ...
        print("Error: 'var' must be a valid JSON list (e.g., '[0.3, 1, 1]').")
        sys.exit(1)
    ...
    try:
        ...
        print("Error: 'lr' must be a valid JSON list (e.g., '[0.04, 0.00004, 0.000004]').")
        sys.exit(1)
